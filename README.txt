...
3. I implemented the AI by firstly using a function that looks at all the 8 directions around its current standing point. Then the function simulate through all the paths to find highest point it can score in each.
